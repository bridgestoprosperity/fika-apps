...
export class MapController {
	...
	constructor(container) {
		...
		mapboxgl.accessToken = 'pk.eyJ1IjoiYnJpZGdlc3RvcHJvc3Blcml0eSIsImEiOiJjbTVyaGcweGswYWpzMnhxMjRyZHhtMGh0In0.4YOL9xCKxxQ0u2wZ7AlNMg';
	...
	setupEventHandlers() {
		...
		this.map.on('style.load', async () => {
			...
			// I'll need to edit the .handlehexclick class
