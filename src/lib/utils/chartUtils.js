...
export const createAccessTimeRadarConfig = (data) => {
	...
	const maxValue = Math.max(
		beforeEducation, afterEducation,
			...
			datasets: [
				{
					...
					data: beforeData,
					backgroundColor: 'rgba(220, 38, 127, 0.3)', // Matte red with transparency
					borderColor: 'rgba(220, 38, 127, 0.8)',
					borderWidth: 2,
					pointBackgroundColor: 'rgba(220, 38, 127, 1)',
					pointBorderColor: 'rgba(220, 38, 127, 1)',
					pointHoverBackgroundColor: 'rgba(220, 38, 127, 1)',
				...
				},
				{
					...
					data: afterData,
					backgroundColor: 'rgba(59, 130, 246, 0.3)', // Matte blue with transparency
...
export const createDemographicsBarConfig = (data) => {
	...
	return {
		type: 'bar',
		data: {
			labels: ['Population', 'Births/Year', 'Pregnancies/Year', 'Female Edu (years)', 'Male Edu (years)'],
			datasets: [{
				label: 'Count/Value',
