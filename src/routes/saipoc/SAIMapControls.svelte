<script>
	...
	const allColumns = [
		...
		'population', 'rwi', 'underweight', 'births', 'pregnancies',
		'pop_0_4', 'females_0_4', 'males_0_4', 
		'pop_5_9', 'females_5_9', 'males_5_9',
		'pop_10_14', 'females_10_14', 'males_10_14',
		'pop_0_9', 'females_0_9', 'males_0_9',
		'pop_15_49', 'females_15_49', 'males_15_49',
		'pop_50_64', 'females_50_64', 'males_50_64',
		'pop_65_plus', 'females_65_plus', 'males_65_plus',
		'female_educational_attainment_mean', 'male_educational_attainment_mean',
		
		// Travel time columns
		'travel_time', 'travel_time_no_sites', 'time_delta_no_sites',
		'travel_time_no_sites_all_health', 'time_delta_no_sites_semi_dense_urban',
		'travel_time_health_posts', 'travel_time_major_roads', 
		'travel_time_no_sites_secondary_schools', 'travel_time_secondary_schools',
		'travel_time_no_sites_health_centers', 'travel_time_no_sites_major_roads',
		'time_delta_no_sites_secondary_schools', 'time_delta_no_sites_all_health',
		'travel_time_health_centers', 'time_delta_no_sites_health_centers',
		'time_delta_no_sites_major_roads', 'travel_time_semi_dense_urban',
		'time_delta_no_sites_major_hospitals', 'travel_time_all_health',
		'travel_time_no_sites_primary_schools', 'travel_time_no_sites_semi_dense_urban',
		'time_delta_no_sites_health_posts', 'travel_time_no_sites_all_education',
		'travel_time_major_hospitals', 'travel_time_no_sites_major_hospitals',
		'travel_time_primary_schools', 'time_delta_no_sites_primary_schools',
		'travel_time_all_education', 'time_delta_no_sites_all_education',
		'travel_time_no_sites_health_posts'
	];

	// Group columns by category for the dropdown
	const columnGroups = {
		'Population': allColumns.filter(col => 
			col === 'population' || col.startsWith('pop_') || 
			col.includes('females_') || col.includes('males_')
		),
		...
		'Travel Time': allColumns.filter(col => col.startsWith('travel_time') && !col.includes('no_sites')),
